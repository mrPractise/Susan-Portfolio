...
from .models import (
    Project, ProjectCategory, Event, TicketType, Booking, BookingTicket
)
...
class BookingAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('booking_date', 'subtotal_amount')
    ...
    def payment_status(self, obj):
        ...
        return format_html(status_map.get(obj.status, '[Invalid Status]')[0])
    ...
    def save_model(self, request, obj, form, change):
        if not change:  # New booking
            obj.total_amount = obj.subtotal_amount
