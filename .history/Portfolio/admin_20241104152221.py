...
# Create admin groups
class PortfolioGroup(admin.AdminSite):
    site_header = 'Portfolio Administration'
    site_title = 'Portfolio Admin'
    index_title = 'Portfolio Management'

class EventsGroup(admin.AdminSite):
    site_header = 'Events Administration'
    site_title = 'Events Admin'
    index_title = 'Events Management'

# Create instances of admin sites
portfolio_admin = PortfolioGroup(name='portfolio_admin')
events_admin = EventsGroup(name='events_admin')

# Register models with Portfolio admin
portfolio_admin.register(ProjectCategory, ProjectCategoryAdmin)
portfolio_admin.register(Project, ProjectAdmin)

# Register models with Events admin
events_admin.register(Event, EventAdmin)
events_admin.register(TicketType, TicketTypeAdmin)
events_admin.register(Booking, BookingAdmin)

# Unregister from default admin
admin.site.unregister([ProjectCategory, Project, Event, TicketType, Booking])