...
class TicketTypeAdmin(admin.ModelAdmin):
    ...
    def sales_display(self, obj):
            ...
            if obj.capacity > 0:
                ...
                return format_html(
                    '<span style="color: {color}">{sold}/{capacity} ({perc:.1f}%)</span>',
...
class EventAdmin(admin.ModelAdmin):
    ...
    def capacity_display(self, obj):
        ...
        if obj.max_capacity > 0:
            ...
            return format_html(
                '<span style="color: {color}">{sold}/{total} ({perc:.1f}%)</span>',
                color='#dc3545' if percentage > 90 else '#28a745',
                sold=total_sold,
                total=obj.max_capacity,
                perc=percentage
            )
        return '0/0 (0%)'
    ...
    def available_capacity(self, obj):
        ...
        return format_html('{available}', available=available)
