...
def project_list(request):
    ...
    # Base queryset with proper optimization
    # Only select_related once for category
    projects = Project.objects.select_related('category').distinct()
    
    # Filter by category if specified
    if category_slug and category_slug != 'all':
        projects = projects.filter(category__slug=category_slug)
    
    # Always put featured projects first, then by date
    ...
    # Get categories with accurate project counts
