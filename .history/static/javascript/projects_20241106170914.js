...
class ImageModal {
    ...
    setupEventListeners() {
        ...
        if (prevBtn) prevBtn.addEventListener('click', () => this.navigateImages('prev'));
        if (nextBtn) nextBtn.addEventListener('click', () => this.navigateImages('next'));
    }
    ...
    openModal(img) {
        ...
        const modalDate = this.modal.querySelector('.metadata-date');
        const modalCategory = this.modal.querySelector('.metadata-category');

        // Clone image for modal
        ...
        if (projectItem) {
            ...
            modalDescription.textContent = projectItem.querySelector('.description').textContent;
            modalDate.textContent = projectItem.querySelector('.date').textContent;
            modalCategory.textContent = projectItem.querySelector('.item-category').textContent;
    ...
    navigateImages(direction) {
        ...
        const currentIndex = items.findIndex(item => item.dataset.projectId === this.currentImageId);
        let nextIndex;
