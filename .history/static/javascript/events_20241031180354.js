...
function initializeCalendarNavigation() {
  ...
  if (prevButton && nextButton) {
    prevButton.addEventListener("click", navigateMonth.bind(null, "prev"));
    nextButton.addEventListener("click", navigateMonth.bind(null, "next"));
  }
}
...
function navigateMonth(direction) {
  ...
  const currentMonth =
    parseInt(currentUrl.searchParams.get("month")) || new Date().getMonth() + 1;
  const currentYear =
