...
function initializeNavScroll() {
  ...
  window.addEventListener("scroll", function () {
    ...
    if (window.scrollY > initialNavOffset) {
      // If so, add a class to the nav to make it "unsticky" and move it down
      nav.classList.add("scrolled");
    } else {
      // Otherwise, remove the class to make it fixed again
      nav.classList.remove("scrolled");
    }
  });
}

// Initialize the nav scroll functionality on page load
