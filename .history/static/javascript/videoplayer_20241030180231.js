class VideoPlayer {
  ...
  openModal() {
    // Clone video element for modal
    const videoClone = this.video.cloneNode(true);
    this.modalContainer.innerHTML = "";
    this.modalContainer.appendChild(videoClone);
    ...
    // Update modal video controls
    const modalPlayer = new VideoPlayer(this.modalContainer);
    modalPlayer.video = videoClone;
  }
