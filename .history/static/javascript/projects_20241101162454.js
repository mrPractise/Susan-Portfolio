class ProjectGallery {
      ...
      btn.addEventListener("click", async (e) => {
        ...
        try {
          ...
          if (data.html && this.gallery) {
            // Clear the initialized players set when changing categories
  ...
  initializeVideoPlayers() {
    ...
    players.forEach((container) => {
      ...
      if (!this.initializedPlayers.has(videoId)) {
        try {
          new VideoPlayer(container);
          this.initializedPlayers.add(videoId);
          console.log("Initialized player for:", videoId);
        } catch (error) {
