class ProjectGallery {
  ...
  initializeVideoPlayers() {
    console.log("Initializing video players..."); // Debug log
    const players = document.querySelectorAll(".custom-video-player");
    console.log("Found video players:", players.length); // Debug log
    ...
    players.forEach((container) => {
      if (!container.hasAttribute("data-initialized")) {
        try {
          ...
          console.log("Initialized player for:", container.dataset.videoId); // Debug log
        } catch (error) {
