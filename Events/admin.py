...
class GalleryCategoryAdmin(admin.ModelAdmin):
    list_display = ('name', 'slug', 'is_default', 'order')
...
class MediaItemAdmin(admin.ModelAdmin):
    list_display = ('title', 'media_type', 'event_date', 'preview_thumbnail', 'is_active')
    list_filter = ('media_type', 'categories', 'is_active', 'event_date')
